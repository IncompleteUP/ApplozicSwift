...
open class ALKGenericCardCell: UICollectionViewCell {
    public struct Font {
        public static var overlayText = UIFont(name: "HelveticaNeue-Medium", size: 12) ??
            UIFont.systemFont(ofSize: 12)
        
        public static var rating = UIFont(name: "HelveticaNeue", size: 12) ??
            UIFont.systemFont(ofSize: 12)
        
        public static var title = UIFont(name: "HelveticaNeue-Medium", size: 14) ??
            UIFont.boldSystemFont(ofSize: 14)
        
        public static var subtitle = UIFont(name: "HelveticaNeue", size: 12) ??
            UIFont.systemFont(ofSize: 12)
    ...
    public struct Config {
        ...
        public static let imageHeight: CGFloat = 76
    ...
    open var overlayText: UILabel = {
        ...
        label.textColor = UIColor(red: 253, green: 151, blue: 6)
    ...
    open var subtitleLabel: UILabel = {
        ...
        label.textColor = UIColor(red: 255, green: 33, blue: 69)
        return label
    }()
    ...
    open class func rowHeight(card: CardTemplate, maxWidth: CGFloat) -> CGFloat {
        ...
        //        return headerHt + titleHeight + subtitleHeight + descriptionHeight + totalButtonHeight
        return 97
    }
    ...
    private func setupConstraints() {
        ...
        view.addViewsForAutolayout(views: [coverImageView, titleLabel, overlayText, subtitleLabel])
        ...
        coverImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10).isActive = true
        coverImageView.topAnchor.constraint(equalTo: view.topAnchor, constant: 10).isActive = true
        coverImageView.widthAnchor.constraint(equalToConstant: 76).isActive = true
        coverImageView.heightAnchor.constraint(equalToConstant: 76).isActive = true
        //        coverImageHeight.isActive = true
        ...
        overlayText.leadingAnchor.constraint(equalTo: titleLabel.leadingAnchor).isActive = true
        overlayText.trailingAnchor.constraint(equalTo: titleLabel.trailingAnchor).isActive = true
        overlayText.bottomAnchor.constraint(equalTo: coverImageView.bottomAnchor).isActive = true
        
        subtitleLabel.leadingAnchor.constraint(equalTo: titleLabel.leadingAnchor).isActive = true
        subtitleLabel.trailingAnchor.constraint(equalTo: titleLabel.trailingAnchor).isActive = true
        subtitleLabel.bottomAnchor.constraint(equalTo: overlayText.topAnchor, constant: -2).isActive = true
        ...
        //        titleStackView.leadingAnchor.constraint(equalTo: coverImageView.leadingAnchor, constant: 10).isActive = true
        //        titleStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -10).isActive = true
        //        titleStackView.topAnchor.constraint(equalTo: coverImageView.topAnchor).isActive = true
        ...
        //        descriptionLabel.topAnchor.constraint(equalTo: coverImageView.topAnchor).isActive = true
